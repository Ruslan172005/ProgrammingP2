...
#include <iterator>
#include <random>
#include <future> // Äîäàíî çàãîëîâî÷íèé ôàéë äëÿ ðîáîòè ç áàãàòîïîòîêîâ³ñòþ
...
Stats ExploreKeyWords(const set<string>& key_words, istream& input) {
    ...
    Stats result;
    for (auto& f : futures) {
        result += f.get(); // Îòðèìóºìî ðåçóëüòàò êîæíîãî àñèíõðîííîãî çàâäàííÿ ³ äîäàºìî éîãî äî çàãàëüíîãî ðåçóëüòàòó
    }
